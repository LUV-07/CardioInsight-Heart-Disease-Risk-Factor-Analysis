...
#  Chest pain type disease rate (your strongest categorical finding)
...
#  Thal (thalassemia result) disease rate
...
#  Number of major vessels (ca) disease rate
...
#  Highest-risk combined segment: older males with asymptomatic chest pain (cp=4)
...
#  Compare to overall baseline disease rate
