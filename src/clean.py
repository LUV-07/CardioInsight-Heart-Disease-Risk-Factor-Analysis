...
# 1. Convert target 'num' (0-4 severity) into binary: 0 = no disease, 1 = disease present
df['target'] = df['num'].apply(lambda x: 0 if x == 0 else 1)

# 2. Handle missing values in 'ca' and 'thal'
...
# 3. Flag (don't drop) cholesterol == 0 as a data quality issue
