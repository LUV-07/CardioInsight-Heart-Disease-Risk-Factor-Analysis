...
# 1. Target distribution — how balanced is disease vs no disease?
...
# 5. Cholesterol vs disease (boxplot) — excluding flagged suspect rows for this view
